...
ListView {
    ...
    delegate: StandardItem {
        ...
        // Qt6 (Qt5Compat.GraphicalEffects) ColorOverlay does not paint an
        // invisible source, so on Wayland the tray icons would stay blank.
        // Render the original SNI icon directly (like the dock does); the
        // ColorOverlay accent below is kept for a pressed-state tint only.
        FishUI.IconItem {
            id: iconItem
            ...
            ColorOverlay {
                ...
                opacity: _trayItem.pressed ? 0.25 : 0
            }
        }

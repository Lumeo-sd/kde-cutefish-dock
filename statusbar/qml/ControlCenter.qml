...
ControlCenterDialog {
    ...
    property bool bluetoothDisConnected: !bluetoothControl.powered
    ...
    function toggleBluetooth() {
        const enable = !bluetoothControl.powered
        bluetoothControl.setPowered(enable)
    }
...
//                }
        ...
        Item {
            ...
            GridLayout {
                ...
                CardItem {
                    ...
                    visible: bluetoothControl.available
        ...
        // Bluetooth devices (click to connect / disconnect)
        ColumnLayout {
            id: bluetoothDevicesItem
            Layout.fillWidth: true
            spacing: 0
            visible: bluetoothControl.available &&
                     bluetoothControl.powered &&
                     bluetoothControl.devices.length > 0

            Repeater {
                model: bluetoothControl.devices
                ...
                Item {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            if (device.connected)
                                bluetoothControl.disconnectDevice(device.address)
                            else
                                bluetoothControl.connectDevice(device.address)
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        Image {
                            ...
                            source: "qrc:/images/" + (FishUI.Theme.darkMode ? "dark" : "light") + "/bluetooth-symbolic.svg"
                            smooth: false
                            antialiasing: true
                        }
                        ...
                        Label {
                            text: device.connected ? qsTr("Connected") : device.paired ? qsTr("Paired") : qsTr("Not connected")
                            font.pointSize: 9
                            color: device.connected ? "#2E7D32" : FishUI.Theme.disabledTextColor
                        }
                    }
                }
            }
